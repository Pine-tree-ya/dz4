...
<html>
<head>
<title>Phrases exported from Typecraft</title>
<meta http-equiv="Content-Type" content="text/html;charset=utf-8">
<style>
  .lbor { border-left: 1px dotted black }
  .rbor { border-right: 1px dotted black; }
  .lrbor { border-left: 1px dotted black; border-right: 1px dotted black; }
  table { border-collapse: collapse; }
  td { padding: 1pt 2.5pt 1pt 2.5pt }
  body { font-size: 12pt; }
</style></head>
<body>
